...
for ( z = 0; z < 8000000.0; z += 0.01 )
  b4:	dd 05 08 08 00 00    	fldl   0x808
  ba:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  c0:	dc c1                	fadd   %st,%st(1)
  c2:	d9 05 10 08 00 00    	flds   0x810
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 43f:	f7 f6                	div    %esi
 441:	0f b6 92 1c 08 00 00 	movzbl 0x81c(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 5b8:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 5bb:	b8 14 08 00 00       	mov    $0x814,%eax
